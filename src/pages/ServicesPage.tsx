  ...
  const services = [
    {
      ...
      description: 'خدمات شاملة لبناء شراكات في المملكة العربية السعودية',
      image: 'https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800',
      features: [
        'بناء شراكات  تمويلية وتشغيلية واستراتيجية ناجحة مع رواد الأعمال الطموحين',
        'شراكة تمويلية (مقابل حصة)',
        'شراكة تشغيلية (مشاركة في الإدارة والقرارات)',
        'شراكة استراتيجية (تكامل في الخدمات أو السوق)',
      ],
