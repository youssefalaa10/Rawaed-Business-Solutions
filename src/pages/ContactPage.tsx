          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                هل أنت مستعد لتوسيع أعمالك في المملكة العربية السعودية؟ اتصل
                بفريق الخبراء لدينا اليوم
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="tel:+9660555630570"
                ...
                <a
                  href="mailto:info@rwdalhulu.com"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => (
              ...
              >
                <div
                  className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${info.bgColor} backdrop-blur-sm border border-white/10 p-6 text-center h-full`}
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${info.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-2xl`}
                  >
                  ...
                  {/* Hover Effect */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${info.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-2xl`}
                  ></div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div
              className="animate-on-scroll slide-up space-y-8"
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                ...
                <div className="space-y-6">
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <div
                        className={`w-12 h-12 bg-gradient-to-r ${benefit.color} rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}
                      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 animate-on-scroll">
            ...
            <p className="text-xl text-gray-300">
              يمكنك زيارتنا في مكتبنا الرئيسي في الرياض
            </p>
          </div>
              ...
              <div className="aspect-video bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-400 mb-6">
                    يمكنك تحديد موعد لزيارة مكتبنا
                  </p>
                  <a
                    href="tel:+966501234567"
